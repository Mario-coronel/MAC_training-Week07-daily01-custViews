...
public class MyAndroidView extends android.support.v7.widget.AppCompatButton{
    ...
    public MyAndroidView(Context context) {
        super(context);
        initView();
    }
    public MyAndroidView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }
    public MyAndroidView(Context context, AttributeSet attrs, int defStyleAttr) {
